...
export const CategoryForm: React.FC<CategoryFormProps> = ({ mode, form }) => {
  ...
  const counterColor =
    characterCount > maxLength ? "text-red-500" : characterCount > 90 ? "text-yellow-500" : "text-gray-400";
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <div id="name-description" className={`flex justify-between items-center text-xs ${counterColor}`}>
                <FormMessage />
